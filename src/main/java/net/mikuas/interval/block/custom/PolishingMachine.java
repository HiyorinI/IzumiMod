...
import net.mikuas.interval.block.entity.PolishingMachineBlockEntity;
...
public class PolishingMachine extends BlockWithEntity implements BlockEntityProvider
{
    ...
    {
        return validateTicker(type, IzumiBoxBlockEntities.POLISHING_MACHINE_BLOCK_ENTITY, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
