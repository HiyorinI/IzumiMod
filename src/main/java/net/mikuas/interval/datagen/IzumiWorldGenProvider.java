...
public class IzumiWorldGenProvider extends FabricDynamicRegistryProvider
{
    public IzumiWorldGenProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture)
    {
