...
{
    public static final Identifier TEXTURE = Identifier.of(Interval.MOD_ID, "textures/gui/polishing_machine_gui.png");
    public static final CategoryIdentifier<PolishingMachineDisplay> POLISHING_MACHINE = CategoryIdentifier.of(Interval.MOD_ID, "polishing_machine");
    ...
    {
        return EntryStacks.of(IzumiBlocks.POLISHING_MACHINE.asItem().getDefaultStack());
    }
