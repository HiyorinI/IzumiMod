package net.mikuas.interval.entity.ai;
...
public class IzumiTigerAttackGoal extends MeleeAttackGoal
{
    private final IzumiTigerEntity entity;
    private int attackDelay = 20;
    private int ticksUntilNextAttack = 20;
    private boolean shouldCountTillNextAttack = false;

    public IzumiTigerAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle)
    {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (IzumiTigerEntity) mob;
    }
