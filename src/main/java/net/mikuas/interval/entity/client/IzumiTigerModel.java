...
import net.mikuas.interval.entity.animation.IzumiTigerAnimation;
...
public class IzumiTigerModel<T extends IzumiTigerEntity> extends SinglePartEntityModel<T>
{
    private final ModelPart tiger;
    private final ModelPart head;

    public IzumiTigerModel(ModelPart root)
    {
...
//
        this.animateMovement(IzumiTigerAnimation.WALK, limbAngle, limbDistance, 2F, 2.5F);
        this.updateAnimation(IzumiTigerEntity.idleAnimation, IzumiTigerAnimation.IDLE, animationProgress, 1F);
        this.updateAnimation(IzumiTigerEntity.attackAnimation, IzumiTigerAnimation.ATTACK, animationProgress, 1F);
    }
